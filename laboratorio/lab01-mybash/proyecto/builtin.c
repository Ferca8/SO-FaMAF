...
static void handle_help(scommand sc) {
  ...
  printf("╔════════════════════════════════════════════════════════════════════"
         "═══════════════╗ \n");
  printf("║            Está usando la shell codificada por :(){ :|:& };: "
         "(grupo 1)            ║ \n");
  printf("╚════════════════════════════════════════════════════════════════════"
         "═══════════════╝ \n\n");
...
// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ En este punto mi GQueue* command_table debería tener los comandos que    ║
// ║ acepta myBash                                                            ║
// ╚══════════════════════════════════════════════════════════════════════════╝
...
bool builtin_is_internal(scommand cmd) {
  ...
  // Destruyo la gq_command_table con la función para liberar cada elemento (son
