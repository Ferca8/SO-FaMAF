...
/* 
    PASO 4: la systemcall sys_sem_[open,close,up,down] lo unico que hace es
    ejecutar sem_[open,close,up,down] con los parámetros correctos. Uso argint
    para pasarle los argumentos a la syscall, todas las de arriba lo hacen.
*/ 
